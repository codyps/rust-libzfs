...
pub mod nvlist_indent_mode {
    pub type Type = ::std::os::raw::c_uint;
    pub const NVLIST_INDENT_ABS: Type = 0;
    pub const NVLIST_INDENT_TABBED: Type = 1;
}
extern "C" {
...
pub mod nvlist_prtctl_fmt {
    pub type Type = ::std::os::raw::c_uint;
    pub const NVLIST_FMT_MEMBER_NAME: Type = 0;
    pub const NVLIST_FMT_MEMBER_POSTAMBLE: Type = 1;
    pub const NVLIST_FMT_BTWN_ARRAY: Type = 2;
}
extern "C" {
    pub fn nvlist_prtctl_setfmt(arg1: nvlist_prtctl_t,
                                arg2: nvlist_prtctl_fmt::Type,
                                arg3: *const ::std::os::raw::c_char);
}
extern "C" {
